...
class Container_27e093f812 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Inventory\InventoryPresenter' => [2 => ['application.1']],
		'App\UI\Error\Error5xx\Error5xxPresenter' => [2 => ['application.2']],
		'App\UI\Error\Error4xx\Error4xxPresenter' => [2 => ['application.3']],
		'App\UI\Edit\EditPresenter' => [2 => ['application.4']],
		'App\UI\Character\CharacterPresenter' => [2 => ['application.5']],
		'NetteModule\ErrorPresenter' => [2 => ['application.6']],
		'NetteModule\MicroPresenter' => [2 => ['application.7']],
		'App\Model\InventoryFacade' => [['02']],
		'App\Model\CharacterFacade' => [['03']],
	];
	...
	public function createService02(): App\Model\InventoryFacade
	{
		return new App\Model\InventoryFacade($this->getService('database.default.explorer'));
	}


	public function createService03(): App\Model\CharacterFacade
	{
		return new App\Model\CharacterFacade($this->getService('database.default.explorer'));
	}


	public function createServiceApplication__1(): App\UI\Inventory\InventoryPresenter
	{
		$service = new App\UI\Inventory\InventoryPresenter($this->getService('02'), $this->getService('03'));
	...
	public function createServiceApplication__4(): App\UI\Edit\EditPresenter
	{
		$service = new App\UI\Edit\EditPresenter($this->getService('03'), $this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\UI\Character\CharacterPresenter
	{
		$service = new App\UI\Character\CharacterPresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
