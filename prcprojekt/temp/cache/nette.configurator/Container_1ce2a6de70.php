<?php
// source: /home/marinakt/PRC1-2024-5/prcprojekt/config/common.neon
// source: /home/marinakt/PRC1-2024-5/prcprojekt/config/services.neon
// source: /home/marinakt/PRC1-2024-5/prcprojekt/config/local.neon
// source: array
...
class Container_1ce2a6de70 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/marinakt/PRC1-2024-5/prcprojekt/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/marinakt/PRC1-2024-5/prcprojekt/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_1ce2a6de70 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/marinakt/PRC1-2024-5/prcprojekt/temp/cache/latte');
	...
	{
		return [
			'appDir' => '/home/marinakt/PRC1-2024-5/prcprojekt/app',
			'wwwDir' => '/home/marinakt/PRC1-2024-5/prcprojekt/www',
			'vendorDir' => '/home/marinakt/PRC1-2024-5/prcprojekt/vendor',
			'rootDir' => '/home/marinakt/PRC1-2024-5/prcprojekt',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/marinakt/PRC1-2024-5/prcprojekt/temp',
		];
	}
}
