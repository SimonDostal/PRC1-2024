<?php
// source: /home/hnatek/PRC1-2024/prcprojekt/config/common.neon
// source: /home/hnatek/PRC1-2024/prcprojekt/config/services.neon
// source: /home/hnatek/PRC1-2024/prcprojekt/config/local.neon
// source: array
...
class Container_76e7855890 extends Nette\DI\Container
{
	...
	public function createService03(): App\Model\InventoryFacade
	{
		return new App\Model\InventoryFacade($this->getService('database.default.explorer'));
	}
	...
	public function createServiceApplication__4(): App\UI\Inventory\InventoryPresenter
	{
		$service = new App\UI\Inventory\InventoryPresenter($this->getService('03'), $this->getService('02'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/hnatek/PRC1-2024/prcprojekt/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/hnatek/PRC1-2024/prcprojekt/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_76e7855890 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/hnatek/PRC1-2024/prcprojekt/temp/cache/latte');
	...
	{
		return [
			'appDir' => '/home/hnatek/PRC1-2024/prcprojekt/app',
			'wwwDir' => '/home/hnatek/PRC1-2024/prcprojekt/www',
			'vendorDir' => '/home/hnatek/PRC1-2024/prcprojekt/vendor',
			'rootDir' => '/home/hnatek/PRC1-2024/prcprojekt',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/hnatek/PRC1-2024/prcprojekt/temp',
		];
	}
}
